...
class _LoginPageState extends State<LoginPage> {
  ...
  void logInUser() async {
    // Location Code Block Continue
    // To Start Location Service
    BackgroundLocation.startLocationService();

    // ŞOFÖRDEN KONUMU SÜREKLİ ALMALIYIZ Kİ UYGULAMA ARKA PLANDAYKEN DE KONUM ALINMAYA DEVAM ETSİN UYGULAMA.

    // To Get location info regularly
    BackgroundLocation.getLocationUpdates((location) {
      // Update blue icon's latitude and longitude values. ( The Driver's location )
      // Add location info to firebase in here.

      String documentId = 'your_document_id';

      //Replace 'field_to_update' and 'new_value' with the field and value you want to update
      Map<String, dynamic> dataToUpdate = {
        'field_to_update': 'new_value',
      };

      _collectionRef.doc(documentId).update(dataToUpdate).then((_) {
    ...
    // To Stop Location Info >> ŞOFÖR KONUMUNU VERMEYİ KESMESİ İÇİN DÜĞME ATANACAK.

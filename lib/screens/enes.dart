...
class _TrackPageState extends State<TrackPage> {
  ...
  void initState() {
    ...
    // print("A: $A");
    // Marker'ın konumu (Örnek bir konum: Ankara, Türkiye)
    LatLng markerLocation = LatLng(39.9208, 32.8541);
    // Marker'ı oluşturun
    _myMarker = Marker(
      markerId: MarkerId('myMarker'), // Eşsiz bir ID belirtin
      position: markerLocation, // Oluşturduğunuz LatLng nesnesini belirtin
      // İsteğe bağlı olarak marker ikonu, rengi ve diğer özellikleri belirtebilirsiniz
      // Örn: icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueBlue),
      //     onTap: () { ... },
      //     ...
    );
  }
  ...
  void _updateLocation() {
    ...
    BackgroundLocation.getLocationUpdates((location) {
      ...
      // Yeni konum bilgileriyle marker'ı güncelle
      _updateMarker(
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return GoogleMap(
                    ...
                    markers: _myMarker != null
                        ...
                        : Set<Marker>(),
                    // Eğer _myMarker null değilse Set içine eklenir, aksi halde boş bir Set oluşturulur.
                  );
                }
              },
            );
            ...
            onPressed: () {
              if (_mapController != null) {
                _mapController!.animateCamera(CameraUpdate.newLatLng(
                  _myMarker!.position, // Marker'ın konumuna odaklanın
                ));
              }
            },
          ),

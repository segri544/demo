                ...
                ElevatedButton(
                  onPressed: () {
                    if (routeName.isNotEmpty && driverName.isNotEmpty) {
                      // Set the route name and driver name here
                      // You can use the 'routeName' and 'driverName' variables to store the entered names
                      print('Route Name: $routeName');
                      print("Driver's Name: $driverName");
                      print("telefon: $PhoneNumber");
                      print('Morning Selected: $isMorningSelected');
                      print('Evening Selected: $isEveningSelected');
                    }
                    Navigator.of(context).pop(); // Close the dialog
                    print("*********************\n");
                    for (int i = 0; i < markerIdCounter; i++) {
                      // Database entries:
                      // 1. Güzergah ismi (routeName)
                      // 2. Şoför adı (driverName)
                      // 3. Marker ID (markers.elementAt(i).markerId.toString())
                      // 4. Lat/Long values (markers.elementAt(i).position)
                    }
                  },
                  child: Text('Save'),
                ),
